...
$sql1="SELECT * FROM post JOIN user ON post.author = user.user_id WHERE post.author={$authorID}";
...
category.category_name,user.username,post.author FROM post 
...
if (mysqli_num_rows($result1) > 0) {
   ...
   $total_page = ceil($total_rec / $limit);
    ...
    if ($total_page > $page) {
        echo '<li><a href="author.php?aid='.$authorID .'&page=' . ($page + 1) . '">Next</a></li>';
    }
   echo " </ul>";
}
?>
